...
-- - Descobrir/validar periféricos essenciais (MineColonies, ME, monitores, destinos)
-- - Montar o `state` canônico (cfg/logger/cache/devices/stats/metrics/work/snapshot)
