...
-- Invariantes:
-- - Snapshot.build(state) não pode acessar `peripheral`/`fs`/`http` (somente copia/normaliza dados)
-- - Estrutura deve ser estável (mesmas chaves sempre presentes, com defaults)
